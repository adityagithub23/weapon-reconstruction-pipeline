...
# # ):
# #     """
# #     Compute adaptive crop so full weapon can be reconstructed.

# #     Args:
# #         image : original image
# #         bbox  : detection bbox [x1,y1,x2,y2]
# #         seg_mask : SAM segmentation mask
# #         expansion_factor : how much larger the reconstruction canvas should be
# #         target_size : diffusion input size
...
# #     seg_crop = seg_mask[crop_y1:crop_y2, crop_x1:crop_x2]
...
# #     seg_resized = cv2.resize(seg_crop, (target_size, target_size))

# #     seg_resized = (seg_resized > 127).astype(np.uint8) * 255

# #     visible_mask = seg_resized
# #     missing_mask = 255 - seg_resized

# #     return crop_resized, visible_mask, missing_mask
...
# ):
#     """
#     Adaptive crop using segmentation mask.
...
#     # ------------------------------------------------
#     # 1️⃣ Use segmentation mask instead of bbox
#     # ------------------------------------------------
...
#     # ------------------------------------------------
#     # 2️⃣ Make square crop (important for diffusion)
#     # ------------------------------------------------

#     max_dim = max(weapon_w, weapon_h)
...
#     crop = image[crop_y1:crop_y2, crop_x1:crop_x2]
#     mask_crop = seg_mask[crop_y1:crop_y2, crop_x1:crop_x2]

#     # ------------------------------------------------
#     # 3️⃣ Resize to diffusion resolution
#     # ------------------------------------------------
...
#     visible_mask = mask_resized
#     missing_mask = 255 - mask_resized
...
def compute_adaptive_crop(
    ...
    # ------------------------------------------------
    # 3️⃣ Resize safely to diffusion size
    # ------------------------------------------------
    ...
    # ------------------------------------------------
    # 4️⃣ Place in center of diffusion canvas
    # ------------------------------------------------
    ...
    mask_canvas = (mask_canvas > 127).astype(np.uint8) * 255

    visible_mask = mask_canvas
    missing_mask = 255 - mask_canvas

    return canvas, visible_mask, missing_mask